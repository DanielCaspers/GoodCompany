angular.module('starter.services', [])
    ...
    .factory('Directory', function() {
      ...
      var directory = [{
        ...
        activities: [ {name:'Chess', id:'5'}, {name:'Gardening', id:'10'}, {name:'Rummy', id:'22'}],
        since:'1427919070000',
        roomNumber: '303',
        ...
        id: 2,
        name: 'Olga Finlayson',
        activities: [ {name:'Reading', id:'21'}, {name:'Drinking', id:'8'}, {name:'Watching TV', id:'26'}],
        since:'1427141470000',
        roomNumber: '242',
        ...
        id: 3,
        name: 'Marie Walton',
        activities: [ {name:'Hiking', id:'12'}, {name:'Biking', id:'1'}, {name:'Travel', id:'24'}],
        since:'1425672670000',
        roomNumber: '117',
        ...
        id: 4,
        name: 'Janet Miller',
        activities: [ {name:'Poker', id:'19'}, {name:'Bridge', id:'4'}, {name:'Window Shopping', id:'28'}],
        since:'1425240670000',
        roomNumber: '321',
        ...
        id: 5,
        name: 'Perry Governor',
        activities: [ {name:'Biking', id:'1'}, {name:'Drinking', id:'8'}, {name:'Museums', id:'15'}],
        since:'1425240670000',
        roomNumber: '237',
        ...
        activities: [ {name:'History', id:'12'}, {name:'Museums', id:'15'}, {name:'Re-enactments', id:'20'}],
        since:'1414008670000',
        roomNumber: '113',
        ...
        id: 7,
        name: 'Hoa Nguyen',
        activities: [ {name:'Gardening', id:'10'}, {name:'Sewing', id:'23'}, {name:'Painting', id:'16'}],
        since:'1405455070000',
        roomNumber: '204',
        ...
        id: 8,
        name: 'Mike November',
        activities: [ {name:'Driving', id:'9'}, {name:'Antiques', id:'0'}],
        since:'1395605470000',
        roomNumber: '309',
        ...
        id: 9,
        name: 'Ilene Killian',
        activities: [ {name:'Reading', id:'21'}, {name:'Book Clubs', id:'3'}, {name:'Cooking', id:'6'}],
        since:'1389989470000',
        roomNumber: '121',
        ...
        activities: [ {name:'Drinking', id:'8'}, {name:'Bingo', id:'2'}],
        since:'1385928670000',
        roomNumber: '216',
        ...
        id: 12,
        name: 'Walter Pollak',
        activities: [ {name:'Walking', id:'25'}, {name:'Parks', id:'17'}, {name:'Poker', id:'19'}],
        since:'1376511070000',
        roomNumber: '305',
 ...
 */
    .factory('Activities', function() {
      ...
      var activities = [{
        ...
        image: 'img/activities/drinking.jpg'
      },{
        id: 9,
        name: 'Driving',
